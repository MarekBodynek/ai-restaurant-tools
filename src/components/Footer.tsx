        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://x.com/restauranttools"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/restauranttools-ai"
                target="_blank"
                rel="noopener noreferrer"
                className="text-stone-500 hover:text-orange-400 transition-colors"
              ...
              <a
                href="https://instagram.com/restauranttools.ai"
                target="_blank"
                rel="noopener noreferrer"
                className="text-stone-500 hover:text-orange-400 transition-colors"
              ...
              <a
                href="mailto:hello@restauranttools.ai"
                className="text-stone-500 hover:text-orange-400 transition-colors"
                aria-label="Email us"
              >
